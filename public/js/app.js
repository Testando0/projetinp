...
function vChat(){
  return `<div class="stitle">▸ CHAT PRIVADO</div>
    <div id="chat-container" class="chat-container">
      ...
      <div id="chat-view-conversa" class="chat-view chat-view-conversa"><div class="chat-card"><div id="chat-header" class="chat-card-head"><button type="button" class="chat-voltar" onclick="voltarParaLista()" aria-label="Voltar">‹</button><span style="color:var(--text-dim);font-size:.85rem;">Selecione um contato</span></div><div id="chat-msgs" class="chat-scroll chat-msgs-area"></div><div id="chat-input-wrap" class="chat-input-wrap"><textarea id="chat-input" placeholder="Digite uma mensagem…" onkeydown="chatInputKeydown(event)"></textarea><button type="button" class="btn btn-primary chat-send" onclick="enviarMsgChat()">➤</button></div></div></div>
    </div>
    <style>
