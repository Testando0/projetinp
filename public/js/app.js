...
function renderTab(idx){
  ...
  const views={home:vInicio,intro:vIntroducao,ocs:vOcAdmin,hist:vHistorico,registrar:vRegistrar,myocs:vOcDelegado,puns:vPunicoes,users:vUsuarios,vips:vVips,meuVip:vMeuVip,contratarVip:vContratarVip,hall:vHall,prisoes:vPrisoes,pontos:vPontos,provas:vProvas,aprovas:vAnaliseProvas,audit:vAuditoria,chat:vChat,roleta:vRoleta};
...
function vContratarVip(){return `<div class="vip-store" style="max-width:860px;margin:0 auto;padding:8px 0 30px;">
  <div style="text-align:center;padding:34px 22px 28px;border:1px solid rgba(251,191,36,.28);border-radius:24px;background:radial-gradient(circle at 50% 0%,rgba(251,191,36,.20),transparent 58%),linear-gradient(145deg,rgba(255,255,255,.06),rgba(255,255,255,.015));box-shadow:0 18px 55px rgba(0,0,0,.28);">
    <div style="font-size:2.2rem;margin-bottom:8px;">👑</div>
    <div style="font-family:'Orbitron',sans-serif;font-size:1.35rem;font-weight:900;letter-spacing:.12em;color:#fbbf24;">COMBOS VIP</div>
    <div style="max-width:520px;margin:12px auto 0;color:var(--text-mid);font-size:.9rem;line-height:1.65;">Escolha seu período VIP e aproveite uma experiência exclusiva, com benefícios especiais e reconhecimento dentro da corporação.</div>
  </div>
  <div class="vip-combos-grid">
    <div class="card" style="text-align:center;padding:24px 14px;border-color:rgba(205,127,50,.42);background:linear-gradient(160deg,rgba(205,127,50,.16),rgba(255,255,255,.025));"><div style="font-size:1.55rem;">🥉</div><div style="margin-top:10px;font-weight:800;color:#e7b17a;">5 DIAS</div><div style="margin-top:12px;font-size:1.35rem;font-weight:900;color:#f8fafc;">4.000</div></div>
    <div class="card" style="text-align:center;padding:24px 14px;border-color:rgba(192,192,192,.42);background:linear-gradient(160deg,rgba(192,192,192,.14),rgba(255,255,255,.025));"><div style="font-size:1.55rem;">🥈</div><div style="margin-top:10px;font-weight:800;color:#d7dbe0;">10 DIAS</div><div style="margin-top:12px;font-size:1.35rem;font-weight:900;color:#f8fafc;">8.000</div></div>
    <div class="card" style="text-align:center;padding:24px 14px;border-color:rgba(251,191,36,.48);background:linear-gradient(160deg,rgba(251,191,36,.17),rgba(255,255,255,.025));"><div style="font-size:1.55rem;">🥇</div><div style="margin-top:10px;font-weight:800;color:#fbbf24;">20 DIAS</div><div style="margin-top:12px;font-size:1.35rem;font-weight:900;color:#f8fafc;">12.000</div></div>
    <div class="card" style="text-align:center;padding:24px 14px;border-color:rgba(103,232,249,.48);background:linear-gradient(160deg,rgba(103,232,249,.15),rgba(255,255,255,.025));"><div style="font-size:1.55rem;">💎</div><div style="margin-top:10px;font-weight:800;color:#67e8f9;">30 DIAS</div><div style="margin-top:12px;font-size:1.35rem;font-weight:900;color:#f8fafc;">20.000</div></div>
  </div>
</div>`;}
