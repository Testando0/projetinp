...
function initWebSocket() {
  ...
  _ws.onopen = () => {
    ...
    // Ping a cada 20s para manter conexão viva em qualquer rede/proxy
  ...
  _ws.onclose = evt => {
    ...
    console.warn(`[WS] Desconectado (${evt.code}). Reconectando em ${delay/1000}s…`);
    _scheduleReconnect();
  };
